...
<body>
    ...
    <main id="container">
        <container>
            <form id="first-form" action="includes/formhandler.php" method="post">
                <label for="firstname">Firstname?</label>
                <input required id="firstname" type="text" name="firstname" placeholder="Firstname....">

                <label for="lastname">Lastname?</label>
                <input required id="text" type="lastname" type="text" name="lastname" placeholder="Lastname....">
        ...
        <!-- <a href="module/loginform.php">Another Login Page</a> -->
    </main>
